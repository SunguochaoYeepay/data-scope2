CREATE TABLE tbl_user_display_config (
    ...
    is_query_condition TINYINT(1) DEFAULT 0 COMMENT '是否为查询条件',
    is_required TINYINT(1) DEFAULT 0 COMMENT '查询条件是否必填',
    default_value VARCHAR(255) COMMENT '查询条件默认值',
    is_advanced_condition TINYINT(1) DEFAULT 0 COMMENT '是否为高级查询条件',
    mask_type VARCHAR(16) COMMENT '数据掩码类型',
    ...
    INDEX idx_frequency (user_id, data_source_id, use_frequency DESC, last_used_at DESC)
